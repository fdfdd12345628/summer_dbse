...
class WebAuthnRegistrationResponse(object):
    ...
    def _verify_attestation_statement(self, fmt, att_stmt, auth_data,
        ...
        # print('att_stmt', att_stmt)
        # print('auth_data', auth_data)
        print('client_data_hash', client_data_hash)
        if fmt == AT_FMT_FIDO_U2F:
            ...
            # print('alg: ', att_stmt['alg'])
            # print('ver: ', att_stmt['ver'])
            # print('sig: ', att_stmt['sig'])
            # print('x5c: ', att_stmt['x5c'])
            # print('certInfo: ', att_stmt['certInfo'])
            # print('pubArea', att_stmt['pubArea'])
            cert_info=att_stmt['certInfo']
            pub_area=att_stmt['pubArea']
            print('cert len: ', len(cert_info))
            print('pub len: ', len(pub_area))
            print('magic: ', cert_info[0:4].hex())
